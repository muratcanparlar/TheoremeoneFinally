    ...
    public class RankingTests
    {
        ...
        public void TestWhenThereAreMoreResultsThanMaxCount_butNoRankTies()
        {
            ...
            var rankingData = new List<CountryRanking>
            {
                ...
                new CountryRanking(2, "Turk", 7),
                new CountryRanking(1, "Turk", 9),
                new CountryRanking(3, "Turk", 5),
                new CountryRanking(4, "Turk", 3),
                new CountryRanking(5, "Turk", 1)
            };
